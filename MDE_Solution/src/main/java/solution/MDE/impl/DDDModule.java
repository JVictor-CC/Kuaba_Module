 ...
 * 
 */
public class DDDModule extends AbstractJavaModule {

	private DDDPeerModule peerModule = null;

	private DDDLifeCycleHandler lifeCycleHandler = null;
	
	private static DDDModule instance;

	public static DDDModule getInstance() {
		return instance;
	}

	@Override
	public DDDPeerModule getPeerModule() {
	 ...
	 */
	public DDDModule(IModuleContext moduleContext) {
		super(moduleContext);

		DDDModule.instance = this;

		this.lifeCycleHandler = new DDDLifeCycleHandler(this);
		this.peerModule = new DDDPeerModule(this, moduleContext.getPeerConfiguration());
	}
