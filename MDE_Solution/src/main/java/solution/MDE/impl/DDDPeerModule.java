...
import solution.MDE.api.IDDDPeerModule;
 ...
 *
 */
public class DDDPeerModule implements IDDDPeerModule {
    private DDDModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public DDDPeerModule(DDDModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
